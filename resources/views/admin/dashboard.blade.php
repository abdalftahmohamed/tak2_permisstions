...
{{--                    check permition--}}
                    ...
                    @permission('add-post')
                    <button type="button" class="btn ripple btn-primary">Add Post</button>
                    @endpermission


                    @permission('delete-post')
                    <button type="button" class="btn ripple btn-danger">Delete Post</button>
                    @endpermission
                    @permission('create-post')
                    <button type="button" class="btn ripple btn-primary">create Post</button>
                    @endpermission
